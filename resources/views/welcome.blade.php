...
<body class="bg-gray-200 p-4">
    <div class="lg:w-3/4 mx-auto py-8 px-6 bg-white rounded-xl">
        <h1 class="text-5xl text-center font-bold mb-8">My To-Do List</h1>
        <div class="mb-6">
            <form class="flex flex-col space-y-4" method="post" action="{{ url('store') }}">
                @csrf
            ...
            @foreach ($todos as $todo)
                <div class="py-4 flex item-center border-b border-gray-300 px-3">
                    <div class="flex-1 pr-8">
                        <h3 class="uppercase  text-lg font-semibold">{{ $todo->title }}</h3>
                    ...
                    <div class="flex space-x-3">
                        ...
                        <a class="py-3 px-1 mb-0 bg-red-500 text-white rounded-lg"
                            onclick="return confirm('are you sure you want to delete this product')"
                            href="{{ url('deletetodo', $todo->id) }}"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
